...
function Kavo.CreateLib(kavName, themeList)
    ...
    if themeList == "VzScripterMain" then
        themeList = themeStyles.VzScripterMain
    elseif themeList == "VzScripterDark" then
        themeList = themeStyles.VzScripterDark
    elseif themeList == "VzScripterLight" then
        themeList = themeStyles.VzScripterLight
    else
